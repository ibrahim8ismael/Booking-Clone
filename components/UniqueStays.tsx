  ...
  const stays = [
    {
      ...
      distance:
        language === "ar" ? "25 كلم من مركز المدينة" : "25 km from center",
      rating: 9.6,
    ...
    },
    {
      ...
      location: language === "ar" ? "القاهرة، مصر" : "Cairo, Egypt",
      distance:
        language === "ar" ? "11.8 كلم من مركز المدينة" : "11.8 km from center",
      rating: 8.6,
    ...
    },
    {
      ...
      location: language === "ar" ? "القاهرة، مصر" : "Cairo, Egypt",
      distance:
        language === "ar" ? "11.6 كلم من مركز المدينة" : "11.6 km from center",
      rating: 8.9,
      ratingText: language === "ar" ? "رائع" : "Fabulous",
      reviews: 8,
      price: "1,076",
    ...
    },
    {
      ...
      location: language === "ar" ? "القاهرة، مصر" : "Cairo, Egypt",
      distance:
        language === "ar" ? "11.7 كلم من مركز المدينة" : "11.7 km from center",
      rating: 10.0,
      ratingText: language === "ar" ? "استثنائي" : "Exceptional",
      reviews: 7,
      price: "1,452",
      ...
      <div className="flex justify-between items-end mb-6">
        <div>
          <h2 className="text-2xl font-bold text-gray-900">
            {language === "ar" ? "الرحلات الحالية" : "Current Tours"}
          </h2>
          <p className="text-gray-500 mt-1">
            {language === "ar"
              ? "اكتشف أحدث العروض والوجهات السياحية"
              : "Discover the latest offers and travel destinations"}
          </p>
        </div>
        <Link
          href="/tours"
          className="text-sm font-bold text-[#0758AA] hover:underline whitespace-nowrap"
        >
            ...
            >
              ...
              >
                ...
                <div className="flex flex-col flex-grow px-2">
                  ...
                  <div className="flex items-center gap-1.5 mb-1 flex-wrap">
                    ...
                    <div className="flex gap-0.5">
                      {Array.from({ length: stay.stars }).map((_, i) => (
                        <div
                          key={i}
                          className="w-2.5 h-2.5 bg-[#FED852] rounded-[1px]"
                        />
                      ))}
                    </div>
                  ...
                  {/* Title */}
                  <h3 className="font-bold text-gray-900 text-base leading-tight mb-2 group-hover:text-[#0758AA] transition-colors">
                    {stay.name}
                  </h3>
                  ...
                  <div className="flex items-baseline justify-end rtl:justify-start gap-1">
                    <span className="text-xs text-gray-500">
                      {language === "ar" ? "ابتداءً من" : "Starting from"}
                    </span>
                    <span className="text-sm text-red-600 line-through mx-1">
                      EGP {stay.oldPrice}
                    </span>
