...
export default function AdminHotelFormPage() {
  ...
  const [rooms, setRooms] = useState([
    { id: '1', type: 'Standard Room', price: 150, adultCap: 2, childCap: 1, view: 'City View', connectedReady: false, count: 10 },
  ]);
  ...
  const t = {
    ...
    addNewHotel: isAr ? 'إضافة فندق جديد (مورد)' : 'Add New Hotel (Vendor)',
    ...
    saveHotel: isAr ? 'حفظ الفندق' : 'Save Hotel',
    ...
    <div className="pb-10 max-w-6xl mx-auto" dir={isAr ? 'rtl' : 'ltr'}>
      <div className="mb-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">{t.addNewHotel}</h1>
            <p className="text-gray-500 text-sm mt-1">{isAr ? 'قم بتهيئة مورد فندق جديد لربطه مع الأفواج والمنتجات' : 'Configure a new hotel vendor to link with travel batches & products'}</p>
          </div>
        </div>
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                <div className="space-y-2 md:col-span-3">
                  ...
                  <Input placeholder={isAr ? 'مثال: فندق ونادي صحي النخيل' : 'e.g. Palm Hotel & Resort'} className="bg-gray-50 h-11 border-gray-200" />
                </div>
              ...
              <div className="space-y-2">
                ...
                <Textarea 
                  placeholder={isAr ? 'وصف تفصيلي للفندق...' : 'Detailed description of the hotel...'} 
          ...
          <section className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="space-y-2">
                ...
                <Input placeholder={isAr ? 'اسم المدير/المبيعات' : 'Sales/Manager Name'} className="bg-gray-50 h-11 border-gray-200" />
              </div>
              <div className="space-y-2">
                <label className="text-sm font-bold text-gray-700">{t.contactPhone}</label>
                <Input placeholder="+123..." className="bg-gray-50 h-11 border-gray-200" dir="ltr" />
              </div>
              <div className="space-y-2">
                <label className="text-sm font-bold text-gray-700">{t.contactEmail}</label>
                <Input type="email" placeholder="vendor@hotel.com" className="bg-gray-50 h-11 border-gray-200" dir="ltr" />
              </div>
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input type="number" placeholder="15" className="bg-gray-50 h-11 border-gray-200 pl-8 rtl:pr-8 rtl:pl-3" />
                </div>
              </div>
            </div>
          </section>
            ...
            <div className="space-y-3">
              {mealPlansList.map(plan => (
                <label key={plan} className="flex items-center gap-3">
                  ...
                  <span className="text-gray-700 font-medium text-sm">{plan}</span>
                </label>
              ))}
            </div>
          </section>
