...
export default function AdminHotelFormPage() {
  ...
  const [rooms, setRooms] = useState([
    { id: '1', type: 'Standard Room', price: 150, capacity: 2, count: 10 },
    { id: '2', type: 'Deluxe Suite', price: 300, capacity: 4, count: 5 }
  ]);

  const t = {
    back: isAr ? 'العودة إلى الفنادق' : 'Back to Hotels',
    addNewHotel: isAr ? 'إضافة فندق جديد' : 'Add New Hotel',
          ...
          <section className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
            ...
            <div className="space-y-6">
              <div className="space-y-2">
                ...
                <Input placeholder={isAr ? 'مثال: فندق ونادي صحي النخيل' : 'e.g. Palm Hotel & Resort'} className="bg-gray-50 h-12 rounded-xl border-gray-200" />
              </div>
              <div className="space-y-2">
          ...
          <section className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2 md:col-span-2">
                ...
                <Input placeholder={isAr ? 'العنوان التفصيلي' : 'Full street address'} className="bg-gray-50 h-11 border-gray-200" />
              </div>
            </div>
          </section>
            ...
            <div className="space-y-3">
              {facilitiesList.map(facility => (
                <label key={facility.id} className="flex items-center gap-3">
                  <input type="checkbox" className="w-4 h-4 rounded border-gray-300 text-[#0071c2] focus:ring-[#0071c2]" />
          ...
          <section className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
            ...
            <div className="border-2 border-dashed border-gray-200 rounded-xl p-8 flex flex-col items-center justify-center text-center bg-gray-50 hover:bg-blue-50/50 hover:border-[#0071c2]/50 transition-colors cursor-pointer group">
              ...
              <p className="text-xs text-gray-500 mb-4 px-2">
                {isAr ? 'اسحب وأفلت الصور هنا، أو انقر للتصفح' : 'Drag and drop images here, or click to browse'}
              </p>
              <Button size="sm" variant="outline" className="font-bold bg-white text-gray-700">
                {t.uploadImages}
              </Button>
            </div>
          </section>
